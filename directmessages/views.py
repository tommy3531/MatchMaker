...
def reply(request, dm_id):
    ...
    title = "<h1>Reply<small> %s for %s</small></h1>" % (parent.subject, parent.sender)
    ...
    return render_to_response('directmessages/compose.html', locals(), context_instance=RequestContext(request))
