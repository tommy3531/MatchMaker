...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'questions_useranswer', 'importance_level',
                      self.gf('django.db.models.fields.CharField')(default='Somewhat Important', max_length=120),
                      keep_default=False)
    ...
    models = {
        ...
        u'questions.useranswer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance_level': ('django.db.models.fields.CharField', [], {'default': "'Somewhat Important'", 'max_length': '120'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['questions.Question']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
